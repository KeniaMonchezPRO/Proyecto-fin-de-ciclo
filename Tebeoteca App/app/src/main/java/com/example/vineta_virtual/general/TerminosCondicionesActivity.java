...
import com.example.vineta_virtual.cliente.comic.OnSwipeTouchListener;
import com.example.vineta_virtual.cliente.comic.ZoomableImageView;
...
public class TerminosCondicionesActivity extends AppCompatActivity implements OnSwipeTouchListener.OnSwipeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnDescargar = findViewById(R.id.btn_descargar);
        ...
        btnPrev.setOnClickListener(v -> {
            if (pageIndex > 0) {
                ...
                Toast.makeText(this, "Fin del documento", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private File copyPdfFromAssets() {
        File file = new File(getCacheDir(), "tyc.pdf");

        try (InputStream in = getAssets().open("tyc.pdf");
