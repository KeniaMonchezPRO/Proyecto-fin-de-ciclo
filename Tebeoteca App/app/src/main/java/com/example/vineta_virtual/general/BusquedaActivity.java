...
import com.example.vineta_virtual.cliente.ClienteAdapter;
...
import com.example.vineta_virtual.lector.LectorAdapter;
...
public class BusquedaActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("BusquedaAct", "ID usuario: " + idUsuario);
        ...
        Log.d("BusquedaAct", "perfil: " + perfil);
        ...
        if(perfil.equals("cliente")) {
            ...
            SharedPreferences.Editor editorUsuario = prefs.edit();
            editorUsuario.putInt("idUsuario", idUsuario);
        }
    ...
    public void mostrarResultados(BusquedaRequest resultado) {
        if (!resultado.getComics().isEmpty()) {
            Log.d("BusquedaActivity","Mostrar comics");
        ...
        if(!resultado.getLectores().isEmpty()) {
            Log.d("BusquedaActivity","Mostrar lectores");
        ...
        if (!resultado.getClientes().isEmpty()) {
            Log.d("BusquedaActivity","Mostrar clientes");
