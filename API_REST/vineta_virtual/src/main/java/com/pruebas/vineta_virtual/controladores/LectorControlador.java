...
public class LectorControlador {
    ...
    @PutMapping("/editar/{idLector}")
    public ResponseEntity<?> editarLector(@PathVariable int idLector, @RequestBody Lector lector) {
        Lector editado = lectorServicio.editarLector(idLector, lector);
